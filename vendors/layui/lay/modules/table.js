...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
  ...
  F.prototype.config = {
    ...
    var r = {
      filter: {title: "screen cols", layEvent: "LAYTABLE_COLS", icon: "layui-icon-cols"},
    ...
    if (i.startTime = (new Date).getTime(), a.url) {
      ...
      a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), i.loading(), t.ajax({
        ...
        headers: a.headers || {},
        success: function (t) {
          "function" == typeof a.parseData && (t = a.parseData(t) || t), t[n.statusName] != n.statusCode ? (i.renderForm(), i.errorView(t[n.msgName] || 'Data returned invalid, success status code should be："' + n.statusName + '": ' + n.statusCode)) : (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"), i.setColsWidth(), "function" == typeof a.done && a.done(t, e, t[n.countName])
        },
        error: function (e, t) {
          i.errorView("Data interface request abnormal：" + t), i.renderForm(), i.setColsWidth()
        }
      })
    ...
    i.layTool.on("click", "*[lay-event]", function (e) {
      ...
      switch (layui.stope(e), j.trigger("table.tool.panel.remove"), l.close(i.tipsIndex), c) {
        ...
        case"LAYTABLE_EXPORT":
          r.ie ? l.tips("Export feature not support IE，please use Chrome", this, {tips: 3}) : s({
            list: function () {
              return ['<li data-type="csv">Export to CSV File</li>', '<li data-type="xls">Export Excel File</li>'].join("")
            }(), done: function (e, l) {
              l.on("click", function () {
